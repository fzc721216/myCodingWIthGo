...
// SayHelloClient is the server API for SayHello service.
//
...
func NewSayHelloClient(cc grpc.ClientConnInterface) (SayHelloClient, SayHelloClient) {
	return &sayHelloClient{cc}, nil
}
